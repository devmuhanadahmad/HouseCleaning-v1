...
@section('content')
      ...
      <div class="container-fluid">
        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
                <div class="d-flex">
                    <h4 class="content-title mb-0 my-auto">{{__('backend.Admins')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{__('backend.Edit admin')}}</span>
                </div>
            </div>
        </div>
        <!-- breadcrumb -->
            ...
            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                <div class="card  box-shadow-0">
                    <div class="card-header">
                        <h4 class="card-title mb-1">{{__('backend.Edit admin')}}</h4>
